...
export const events: ScheduleEvent[] = [ // PLACEHOLDERS: Update all event times, descriptions, and locations as they are finalized
  {
    ...
    location: "Sol Heumann Hall Reading Room", 
    address: "47 Greenleaf Ct, Rochester, NY 14623",
  ...
  // },
  {
    ...
    description: "A free bus is available to transport you to the Wintergarden for our formal dinner. The bus will make its first stop at RIT at the Eastman Circle, then visit the Courtyard by Marriott Rochester Brighton, and the Hampton Inn & Suites Rochester/Henrietta. The busses will take multiple rounds.",
    date: "Saturday, April 11, 2026",
